...
export interface ProxyManagerAccessControl extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): ProxyManagerAccessControl;
  clone(): ProxyManagerAccessControl;
  methods: {
    ...
    /**
     * Transfers ownership of the proxy manager to a new account.
     */
